...
function renderTours(tours, container) {
  ...
  tours.forEach(function(tour) {
    ...
    if (tour.featured) {
      featuredBadgeHtml = '<span class="tour-card__badge">' + t.featuredBadge + '</span>';
    }
...
function initMobileMenu() {
  ...
  // Clonar o botão elimina todos os listeners previamente registados
  // (incluindo os dos inline scripts das páginas HTML)
  const newToggle = toggle.cloneNode(true);
  toggle.parentNode.replaceChild(newToggle, toggle);

  // Garantir type="button" para evitar comportamento inesperado em iOS
